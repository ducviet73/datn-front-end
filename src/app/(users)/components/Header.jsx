        ...
        <header className="position-relative bg-white border">
          ...
          <div className="container p-2 d-flex justify-content-between align-items-center">
            ...
            <div className="d-flex align-items-center ms-5">
              ...
              {showCartPreview && (
                <div className="cart-preview position-absolute top-100 end-0 bg-white shadow-sm p-2 mt-1" style={{width: '250px', maxHeight: '300px', overflowY: 'auto', zIndex: 1000}}>
                  {cartItems.length > 0 ? (
                    <>
                      ...
                      <div className="text-center mt-3">
                        <Link href="/cart" className="btn btn-primary btn-sm">Xem giỏ hàng</Link>
                      </div>
                    </>
                  ) : (
            ...
            >
              <li className="nav-item dropdown taikhoan-icon">
                <a className="nav-link" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  <i className="bi bi-person-circle fs-5 fw-bolder text-dark" /> <span>{user ? `${user.username}` : ""}</span>
                </a>
                <ul className="dropdown-menu">
